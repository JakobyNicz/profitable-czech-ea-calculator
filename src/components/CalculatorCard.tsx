  ...
  return <div className="gradient-border p-6 animate-fade-in">
      <div className="space-y-6">
        ...
        <div className="text-center text-xs text-muted-foreground">
          {isFirstDeposit ? <span>Maximální možný kreditní bonus 150% + 25% je do celkového vkladu 50.000 USD!</span> : <span>Bonus: 25% z vkladu je do celkového vkladu 50.000 USD!</span>}
        </div>
      </div>
    </div>;
};